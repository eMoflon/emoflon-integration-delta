 ...
 * @generated
 */
public class DeltaSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case DeltaPackage.DELTA_CONTAINER: {
			DeltaContainer deltaContainer = (DeltaContainer) theEObject;
			T result = caseDeltaContainer(deltaContainer);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T caseDeltaContainer(DeltaContainer object) {
		return null;
	}
